...
class Lekar:
    ...
    def dodavanje_pacijenta(self):
        ...
        if(ok != True):
            ...
            self.lista_pacijenata.append(self.pomocna(ime,prezime,jmbg))
            print()
            print("Šifra Vašeg pacijenta je njegov jmbg, a username - " + ime + prezime)
            return True
...
class Admin:
    ...
    def dodavanje_lekara(self):
        ...
        if(ok):
            ...
            fajl.close()
            print()
            print("Šifra Vašeg lekara je " + str(rand) + ", a username - " + ime + prezime)
    ...
    def brisanje_lekara(self):
        import os
        ime = input("Unesite kog lekara želite da otpustite ")
        ime = ime.replace(" ", "")
...
def login(s):    
        ...
        if(s == 'a'):
            ...
            if not path.exists(user + ".txt"):
                ...
                lekarime = input("Ime Vašeg lekara: ")
                lekarpre = input("Prezime Vašeg lekara: ")
...
def menu3(user,passw):
        ...
        while(br!='10'):
            ...
            print(" 1 - Štampaj listu pregleda\n 2 - Logout")  
            br = input("Unesite vašu opciju: ")
            if(br == '1'):
